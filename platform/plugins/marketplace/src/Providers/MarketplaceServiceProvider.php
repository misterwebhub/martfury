...
use Botble\Marketplace\Repositories\Caches\VendorPaidAdsCacheDecorator;
...
use Botble\Marketplace\Repositories\Eloquent\VendorPaidAdsRepository;
...
class MarketplaceServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        if (is_plugin_active('ecommerce')) {
            ...
            /**
             * Vendor Paid Ads Management Binding
             */
            $this->app->bind(VendorPaidAdsInterface::class, function () {
                return new VendorPaidAdsCacheDecorator(
                    new VendorPaidAdsRepository(new VendorPaidAds)
                );
            });
