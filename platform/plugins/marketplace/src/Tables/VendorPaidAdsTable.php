        ...
        $data = $this->table
            ...
            ->addColumn('operations', function ($item) {
                if ($item->status != 'published') {
                    return '<a href="' . url('vendor/payment-request/' . base64_encode($item->id)) . '" class="btn btn-icon btn-sm btn-success" data-bs-toggle="tooltip" data-bs-original-title="Pay"><i class="fas fa-money-check"></i> </a>';
                } else {
                    return '';
                }
            });
