...
use Botble\Marketplace\Http\Controllers\Fronts\VendorPaidAdsController;
...
Route::group([
    ...
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        ...
        Route::group([
            ...
            Route::resource('ads-managements', 'VendorPaidAdsController')
                ->parameters(['' => 'ads-managements'])
                ->only([
                    'index',
                    'create',
                    'store',
            ...
            Route::get('api/ads-managements/validate-date', [VendorPaidAdsController::class, 'validate_date_range']);
            Route::get('api/ads-managements/show-available-slot', [VendorPaidAdsController::class, 'get_available_slot_info']);
            Route::get('payment-request/{ads_id}', [VendorPaidAdsController::class, 'payment_options'])->name('marketplace.vendor.payment-request');;
            Route::get('payment-success/{ads_id}/{payment_mode?}', [VendorPaidAdsController::class, 'paidAdsPaymentSuccess']);



            Route::group(['prefix' => 'importcjproduct', 'as' => 'importcjproduct.'], function () {
                Route::resource('', 'ImportcjproductController')
                    ->parameters(['' => 'importcjproduct']);

                Route::post('get_products_from_dropship_category', [
                    'as'         => 'get_products_from_dropship_category',
                    'uses'       => 'ImportcjproductController@get_products_from_dropship_category',
                    'permission' => 'importcjproduct.get_products_from_dropship_category',
                ]);

                Route::get('get_products_from_dropship', [
                    'as'         => 'get_products_from_dropship',
                    'uses'       => 'ImportcjproductController@get_products_from_dropship',
                    'permission' => 'importcjproduct.get_products_from_dropship',
                ]);
            });
