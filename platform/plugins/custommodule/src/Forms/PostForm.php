...
namespace Botble\CustomModule\Forms;

use Botble\Base\Enums\BaseStatusEnum;
use Botble\Base\Forms\Fields\TagField;
use Botble\Base\Forms\FormAbstract;
use Botble\CustomModule\Forms\Fields\CategoryMultiField;
    ...
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('categories[]', 'categoryMulti', [
                'label'      => trans('plugins/CustomModule::posts.form.categories'),
                'label_attr' => ['class' => 'control-label required'],
            ...
            ->add('tag', 'tags', [
                'label'      => trans('plugins/CustomModule::posts.form.tags'),
                'label_attr' => ['class' => 'control-label'],
                'value'      => $tags,
                'attr'       => [
                    'placeholder' => trans('plugins/CustomModule::base.write_some_tags'),
        ...
        if (count($postFormats) > 1) {
            $this->addAfter('status', 'format_type', 'customRadio', [
                'label'      => trans('plugins/CustomModule::posts.form.format_type'),
                'label_attr' => ['class' => 'control-label'],
