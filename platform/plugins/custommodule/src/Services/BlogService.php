        ...
        switch ($slug->reference_type) {
            case Post::class:
                ...
                if (function_exists('admin_bar') && Auth::check() && Auth::user()->hasPermission('posts.edit')) {
                    admin_bar()->registerLink(
                        trans('plugins/CustomModule::posts.edit_this_post'),
                ...
                return [
                    'view'         => 'post',
                    'default_view' => 'plugins/CustomModule::themes.post',
                    'data'         => compact('post'),
                    'slug'         => $post->slug,
                ];
            case Category::class:
                ...
                if (function_exists('admin_bar') && Auth::check() && Auth::user()->hasPermission('categories.edit')) {
                    admin_bar()->registerLink(
                        trans('plugins/CustomModule::categories.edit_this_category'),
                ...
                return [
                    'view'         => 'category',
                    'default_view' => 'plugins/CustomModule::themes.category',
            ...
            case Tag::class:
                ...
                if (function_exists('admin_bar') && Auth::check() && Auth::user()->hasPermission('tags.edit')) {
                    admin_bar()->registerLink(trans('plugins/CustomModule::tags.edit_this_tag'), route('tags.edit', $tag->id));
                }
                ...
                return [
                    'view'         => 'tag',
                    'default_view' => 'plugins/CustomModule::themes.tag',
