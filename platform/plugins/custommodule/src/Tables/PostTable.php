...
namespace Botble\CustomModule\Tables;

use BaseHelper;
use Botble\Base\Enums\BaseStatusEnum;
use Botble\CustomModule\Exports\PostExport;
...
class PostTable extends TableAbstract
{
    ...
    public function columns()
    {
        return [
            ...
            'updated_at' => [
                'title'     => trans('plugins/CustomModule::posts.categories'),
                'width'     => '150px',
                'class'     => 'no-sort text-center',
                'orderable' => false,
            ],
            'author_id'  => [
                'title'     => trans('plugins/CustomModule::posts.author'),
                'width'     => '150px',
                'class'     => 'no-sort text-center',
                'orderable' => false,
            ],
    ...
    public function getBulkChanges(): array
    {
        return [
            ...
            'category'   => [
                'title'    => trans('plugins/CustomModule::posts.category'),
                'type'     => 'select-search',
                'validate' => 'required',
