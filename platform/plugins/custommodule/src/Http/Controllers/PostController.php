...
class PostController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/CustomModule::posts.menu_name'));
    ...
    {
        page_title()->setTitle(trans('plugins/CustomModule::posts.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/CustomModule::posts.edit') . ' "' . $post->name . '"');
    ...
    public function getWidgetRecentPosts(Request $request, BaseHttpResponse $response)
    {
        ...
        return $response
            ->setData(view('plugins/CustomModule::posts.widgets.posts', compact('posts', 'limit'))->render());
    }
}
