...
class PublicController extends Controller
{
     ...
     */
    public function getTag($slug, BlogService $custommoduleService)
    {
        ...
        $data = $custommoduleService->handleFrontRoutes($slug);
    ...
    /**
     * @param string $slug
     * @param BlogService $custommoduleService
     * @return RedirectResponse|Response
     */
    public function getPost($slug, BlogService $custommoduleService)
    {
     ...
     * @return RedirectResponse|Response
     */
    public function getCategory($slug, BlogService $custommoduleService)
    {
