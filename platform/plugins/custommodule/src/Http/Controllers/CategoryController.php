...
use Botble\CustomModule\Forms\CategoryForm;
use Botble\CustomModule\Models\Category;
use Botble\CustomModule\Http\Requests\CategoryRequest;
...
class CategoryController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/CustomModule::categories.menu'));
    ...
    {
        page_title()->setTitle(trans('plugins/CustomModule::categories.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request, BaseHttpResponse $response)
    {
        ...
        page_title()->setTitle(trans('plugins/CustomModule::categories.edit') . ' "' . $category->name . '"');
